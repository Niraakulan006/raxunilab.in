			...
			<div class="col-lg-4 col-md-6">
				<div class="heading3 font1 pb-3">Contact Information</div>
					...
					<div class="d-flex align-items-center pb-3 mb-2">
						...
						<div class="icon-info">
							<div class="font1">Call Us</div>
							<div class="font2 smallfnt m-0 p-0">+91 89785 43300 </div>
						</div>
					</div>
					<!-- <div class="d-flex align-items-center pb-3 mb-2">
						<div class="topicon">
						...
						<div class="icon-info">
							<div class="font1">Whatsapp No</div>
							<div class="font2 smallfnt m-0 p-0">+91 99999 99999</div>
						</div>
					</div> -->
					<div class="d-flex align-items-center pb-3 mb-2">
						<div class="topicon">
			...
			<div class="col-lg-2 col-md-6">
				<div class="heading3 font1 pb-2 mb-lg-3">Quick Links</div>
					<div class="contact-menu">
						<ul>
							<li><a class="font2" href="index.php">Home</a></li>
							<li><a class="font2" href="about.php">About Us</a></li>
							<li><a class="font2" href="products.php">Products</a></li>
							<li><a class="font2" href="newsletter.php">Newsletter</a></li>
							<li><a class="font2" href="contact.php">Contact Us</a></li>
						</ul>
					</div>
			</div>
			<div class="col-lg-3 col-md-6">
