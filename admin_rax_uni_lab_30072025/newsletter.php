<?php 
    ...
    $newsletter_record = array(); $newsletter_record_count = 0; $newsletter_id = "";
...
<script>
    $(document).ready(function(){
        ...
        <?php 
        if(empty($newsletter_record_count)){ ?>
            ShowModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '');
            <?php
        }else { ?>
             ShowModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($newsletter_id)) { echo $newsletter_id; } ?>');
        <?php } ?>
