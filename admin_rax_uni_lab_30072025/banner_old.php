...
<section id="content-wrapper">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
			<h3 class="headfnt"> Home Banner </h3>
		</div>
        ...
        <div class="col-lg-12">
			<div class="border card-box">
                ...
                <?php } else { 
                    ...
                    $position = $GLOBALS['home_position_banner']; $home_banners = ""; 
                    $desktop_home_banner = ""; $desktop_home_banner_positions = ""; $desktop_home_banner_category_ids = ""; 
                    $mobile_home_banner = ""; $mobile_home_banner_positions = ""; $mobile_home_banner_category_ids = "";
                    if(!empty($position)) {
                        $position = $obj->encode_decode('encrypt', $position);
                        $home_banners = $obj->getTableColumnValue($GLOBALS['home_page_table'], 'position', $position, 'position_content');
                        if(!empty($home_banners)) {
                            $home_banners = explode("$$$", $home_banners);
                            if(!empty($home_banners['0'])) {
                                $desktop_home_banners = "";
                                $desktop_home_banners = $home_banners['0'];
                                if(!empty($desktop_home_banners)) {
                                    $desktop_home_banners = explode("@@@", $desktop_home_banners);
                                    if(!empty($desktop_home_banners[0])) {
                                        $desktop_home_banner = $desktop_home_banners[0];
                                        if(!empty($desktop_home_banner)) {
                                            $desktop_home_banner = explode(",", $desktop_home_banner);
                                        }
                                    }
                                    if(!empty($desktop_home_banners[1])) {
                                        $desktop_position_category = "";
                                        $desktop_position_category = $desktop_home_banners[1];
                                        if(!empty($desktop_position_category)) {
                                            $desktop_position_category = explode("###", $desktop_position_category);
                                            if(!empty($desktop_position_category['0'])) {
                                                $desktop_home_banner_positions = $desktop_position_category['0'];
                                            }
                                            if(!empty($desktop_position_category['1'])) {
                                                $desktop_home_banner_category_ids = $desktop_position_category['1'];
                                            }
                                            if(!empty($desktop_home_banner_positions)) {
                                                $desktop_home_banner_positions = explode(",", $desktop_home_banner_positions);
                                            }
                                            if(!empty($desktop_home_banner_category_ids)) {
                                                $desktop_home_banner_category_ids = explode(",", $desktop_home_banner_category_ids);
                                            }
                                        }
                                    }
                                }
                            }
                            if(!empty($home_banners['1'])) {
                                $mobile_home_banners = "";
                                $mobile_home_banners = $home_banners['1'];
                                if(!empty($mobile_home_banners)) {
                                    $mobile_home_banners = explode("@@@", $mobile_home_banners);
                                    if(!empty($mobile_home_banners[0])) {
                                        $mobile_home_banner = $mobile_home_banners[0];
                                        if(!empty($mobile_home_banner)) {
                                            $mobile_home_banner = explode(",", $mobile_home_banner);
                                        }
                                    }
                                    if(!empty($mobile_home_banners[1])) {
                                        $mobile_position_category = "";
                                        $mobile_position_category = $mobile_home_banners[1];
                                        if(!empty($mobile_position_category)) {
                                            $mobile_position_category = explode("###", $mobile_position_category);
                                            if(!empty($mobile_position_category['0'])) {
                                                $mobile_home_banner_positions = $mobile_position_category['0'];
                                            }
                                            if(!empty($mobile_position_category['1'])) {
                                                $mobile_home_banner_category_ids = $mobile_position_category['1'];
                                            }
                                            if(!empty($mobile_home_banner_positions)) {
                                                $mobile_home_banner_positions = explode(",", $mobile_home_banner_positions);
                                            }
                                            if(!empty($mobile_home_banner_category_ids)) {
                                                $mobile_home_banner_category_ids = explode(",", $mobile_home_banner_category_ids);
                                            }
                                        }
                                    }
                                }
